#!/usr/bin/env python3
"""Generate a scene for Calliope.AI RP engine.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Calliope.AI scene generator")
    ...
    output_content = (
        ...
        f"\n"
        f"---\n"
        f"_Generated by Calliope.AI M3 — {timestamp}_\n"
    )
